...
const ProjectsPage = () => (
  <Layout title="My work.">
    ...
    <div className={`${styles.screenshots} screenshots grid` } aria-label="screenshots of the project">
      <figure>
        <img src={psTests} alt="Tests for Dropbox oAuth2" className="shadow-md w-64 h-48 object-cover object-top" />
    ...
    <div className={`${styles.screenshots} screenshots grid` } aria-label="animation showing how the extension works">
      <figure>
        <img src={chromeExtBeforeGIF} alt="results before the broadcasts were uploaded" className="shadow-md w-64" />
        <figcaption className="text-xs py-2 italic">before the broadcasts were uploaded to SoundCloud</figcaption>
      </figure>
      <figure>
        <img src={chromeExtAfterGIF} alt="results after the broadcasts were uploaded" className="shadow-md w-64" />
